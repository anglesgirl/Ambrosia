...
(function ($) {
  ...
  Game_Interpreter.prototype.pluginCommand = function(command, args) {
    ...
    else if (command.toLowerCase() === "add_troop_daimaoabu") {
	  var troopId1 = $gameVariables.value(2045);
	  var troopId2 = $gameVariables.value(2046);
	  var troopId3 = $gameVariables.value(2047);
	  if (troopId1 > 0){$gameTroop.addTroopReinforcements(troopId1);}
	  if (troopId2 > 0){$gameTroop.addTroopReinforcements(troopId2);}
	  if (troopId3 > 0){$gameTroop.addTroopReinforcements(troopId3);}	   
    }	
    else {
